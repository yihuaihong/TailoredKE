...
def demo_model_editing(
    ...
    params_name = (
        "/home/liangyunzhen/yhhong/Unlearning/memit-main"  #"/home/yhhong/Unlearning/memit-main"
        / HPARAMS_DIR
        / hparams_prefix
        / f"{model.config._name_or_path.replace('/', '_')}{hparams_suffix}.json"
    )
    print('HPARAMS_DIR: ',HPARAMS_DIR)
    print('hparams_prefix: ', hparams_prefix)
    print('xxxx: ', f"{model.config._name_or_path.replace('/', '_')}{hparams_suffix}.json")
